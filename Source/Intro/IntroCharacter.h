...
UCLASS(config=Game)
class AIntroCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable)
	void SetActiveChar(class AIntroCharacter* ActiveChar_In) { CurrentActiveChar = ActiveChar_In; }
